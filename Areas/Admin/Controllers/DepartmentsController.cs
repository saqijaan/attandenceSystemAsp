...
namespace AttendanceSystem.Areas.Admin.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var departments = db.Departments.Include(d => d.operatingUnit);
        ...
        {
            ViewBag.operatingUnit_id = new SelectList(db.OperatingUnit, "id", "name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id,name,operatingUnit_id")] Department department)
        {
